...
export class CalendarioActividadBuscarResponse {
    ...
    nUsuelimina: number;
    vCoidigoComision: string;
    vFechaInicioActividad: string;
    vFechaFinActividad: string;
    dFechaActividad: Date;
    dFechaInicioActividad: Date;
    dFechaFinActividad: Date;
}